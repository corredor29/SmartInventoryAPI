...
namespace Domain.Entities.Products
{
    public sealed class Product : BaseEntity
    {
        ...
        public Product(int categoryId, int productStatusId, ProductName name, ProductPrice price, ProductDescription? description = null)
        {
        ...
        public void Update(ProductName name, ProductPrice price, ProductDescription? description, int categoryId)
        {
            Name        = name  ?? throw new ArgumentNullException(nameof(name));
            Price       = price ?? throw new ArgumentNullException(nameof(price));
            Description = description;
